...
def test_inference():
    ...
    project = infer(task.project, "../obj_det/models/Coccolith/model.pt", ["Coccolith", "Coccosphere", "Foraminifera"],
                    0.5, nv=False)
    project.summary()
...
def test_inference_directory():
    project = infer_object_detector_directory(r"/mnt/c/Users/ross.marchant/data/rapp_test",
                                              r"/mnt/c/Users/ross.marchant/data/rapp_test_crop",
                                              "../obj_det/models/",
                                              "Coccolith",
                                              0.5,
                                              4)

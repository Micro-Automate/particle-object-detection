...
These files in this directory are taken from the torchvision repository

Some augmentations have been added, and the data loader changed to also return the filename of the image

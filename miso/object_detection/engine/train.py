...
def main(args):
    ...
    dataset, num_classes = get_dataset(args.train_dataset, "train", get_transform(True, args), args.data_path)
    dataset_test, _ = get_dataset(args.train_dataset, "val", get_transform(False, args), args.data_path)
